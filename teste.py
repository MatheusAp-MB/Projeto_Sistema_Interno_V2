...
# Vídeos (Postagem, PreparacaoVideoFase, AndamentoAgenda, ProgressoProducaoVideo,
# RoadmapAgenda, SnapshotArquivosDrive) de TODO produto, real ou de teste, e
# apaga os produtos de teste (EAN "TESTE-AGENDA-...") por inteiro. ConfiguracaoFase
# NÃO é tocada — fica com os períodos reais já validados.
#
# Reaplica automaticamente reestruturacao_manual nos 73 produtos legados no
# final — sem isso, a tag que acabamos de aplicar se perderia junto com o
# resto de RoadmapAgenda.
