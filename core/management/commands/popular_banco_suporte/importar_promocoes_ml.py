...
def importar_promocoes_ml(stdout, style, caminho=CAMINHO_PROMOCOES):
    ...
    with contar_consultas() as contador:
        ...
        #                  atualizar — substitui "not in para_atualizar"
        #                  (checagem numa LISTA, O(n), ficava mais lenta
        #                  a cada item — CONFIRMADO com prova real: tempo
        #                  por bloco de 500 acelerava de 0,6s pra 26,9s
        #                  entre o 1º e o penúltimo bloco). set() é O(1),
        #                  não importa quantos itens já foram processados.
