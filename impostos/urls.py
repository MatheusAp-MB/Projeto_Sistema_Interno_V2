...
urlpatterns = [
    ...
    path('icms-por-ncm/origens-disponiveis/', views.view_origens_disponiveis_icms_ncm, name='impostos_origens_disponiveis_icms_ncm'),
    path('icms-por-ncm/csts-disponiveis/', views.view_csts_disponiveis_icms_ncm_origem, name='impostos_csts_disponiveis_icms_ncm_origem'),
