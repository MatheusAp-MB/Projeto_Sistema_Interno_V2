...
# Função Objetivo: Tela editável de Configuração Operacional (coleta/armazenagem).
# Explicação em detalhe: substitui as seções "Geral"/"Faixas" que existiam dentro de
# Configurações Mercado Livre — são custo FÍSICO compartilhado por todos os
# marketplaces, não config exclusiva do ML (17/07). 2 formulários independentes,
# mesmo padrão Post-Redirect-Get da tela de config do ML.
