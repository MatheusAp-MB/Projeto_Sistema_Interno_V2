    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preco_de_exibicao', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ...
                ('produto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grade_precificacao_shopee', to='produtos.produto')),
            ],
            options={
