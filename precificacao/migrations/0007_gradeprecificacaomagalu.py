...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('precificacao', '0006_configuracaooperacional_faixaarmazenagem'),
        ('produtos', '0004_rename_altura_produto_altura_produto_sem_embalar_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='GradePrecificacaoMagalu',
            fields=[
                ...
                ('produto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grade_precificacao_magalu', to='produtos.produto')),
            ],
            options={
