...
class FormulaPrecificacaoMagalu:
    ...
    def resolver_dimensao(self):
        ...
        self._altura = produto.altura_produto_apos_embalado or Decimal('0')
        self._largura = produto.largura_produto_apos_embalado or Decimal('0')
        self._comprimento = produto.comprimento_produto_apos_embalado or Decimal('0')
        peso_fisico = produto.peso_produto_apos_embalado or Decimal('0')
        peso_cubico = produto.peso_cubado or Decimal('0')
        self._peso = max(peso_fisico, peso_cubico)
