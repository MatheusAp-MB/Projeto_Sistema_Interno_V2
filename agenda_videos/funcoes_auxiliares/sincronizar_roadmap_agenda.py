...
from agenda_videos.models import IndicadoresAgendaProduto, StatusManualAgenda
...
def calcular_indicadores(produto, ciclo_mais_recente):
...
def sincronizar_indicadores_agenda_produto(produto):
    ...
    indicadores, _ = IndicadoresAgendaProduto.objects.update_or_create(produto=produto, defaults=valores)
    return indicadores