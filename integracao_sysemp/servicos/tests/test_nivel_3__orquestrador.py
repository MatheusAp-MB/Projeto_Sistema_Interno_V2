...
def _item_padrao(**overrides) -> dict:
    valores = {
        ...
        'NR NF': '1001', 'Data Entrada da Nota': '2026-08-01', 'Emissão': '2026-07-30',
        'Fornecedor': 'Fornecedor Teste', 'CFOP': '1.102', 'Natureza da Operacao': 'Compra',
        'Chave': 'chave-teste',
        'TES Saida': 1, 'NCM': '00000000', 'Origem': '0', 'Origem Descricao': 'Nacional',
        'Base Calculo ICMS ST': 0, 'Aliquota ICMS ST': 0, 'Redução ICMS ST': 0, 'Valor ICMS ST': 0,
        'CST ICMS': 0, 'Base Calculo ICMS': 100, 'Aliquota ICMS': 18, 'Redução ICMS': 0, 'Valor ICMS': 18,
        'Base ICMS Ret': 0, 'Valor ICMS Ret': 0,
        'CST IPI': 0, 'Base Calculo IPI': 100, 'Aliquota IPI': 5, 'Valor IPI': 5,
        'CST PIS': 0, 'Base Calculo PIS': 100, 'Aliquota PIS': 1.65, 'Valor PIS': 1.65,
        'CST COFINS': 0, 'Base Calculo COFINS': 100, 'Aliquota COFINS': 7.6, 'Valor COFINS': 7.6,
